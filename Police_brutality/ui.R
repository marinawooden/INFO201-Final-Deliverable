...
tagList(
  ...
  navbarPage(
    title = "An Analysis of Fatal Shootings by Police",
    header = "",
    id = "navtab",
    ...
    tabPanel(
      ...
      p("The fatal police shootings dataset was relatively
                          ...
                          know where to begin, so we chose to map it all.
                          To show
                          ...
                          have as much gravity. To get the coordinates, we
                          joined
      ...
      p("The next graphic was meant to show the proportion
                          ...
                          , but we were surprised to see that in total, there
                          were
      ...
      p(
        ...
        a("2017 ACS Demographic and Housing data",
          href = "https://www.census.gov/data/datasets/2017/demo/popproj/2017-popproj.html"),
    ...
    tabPanel(
      ...
      p("Through our research, we found that young, black men
                        ...
                        U.S population which is black. We also found that
                        younger
